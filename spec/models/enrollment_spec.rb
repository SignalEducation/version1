...
describe Enrollment do
  ...
  describe 'validations' do
    before do
      @enrollment = build(:enrollment, user_id: 1, course_id: 1,
                          course_log_id: 1, exam_body_id: 1, exam_sitting_id: 1)
    end
    ...
    it 'should have a valid course_id' do
      expect{ @enrollment.course_id = nil }.to change{ @enrollment.valid? }.to false
    end
  ...
  describe 'callbacks' do
    ...
    it { should callback(:create_course_log).before(:validation) }
  ...
  describe 'scopes' do
    ...
    it { expect(Enrollment).to respond_to(:for_course) }
