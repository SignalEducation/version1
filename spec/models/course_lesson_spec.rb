...
describe CourseLesson do
  describe 'relationships' do
    ...
    it { should have_many(:course_videos) }
  ...
  describe 'scopes' do
    it { expect(CourseLesson).to respond_to(:all_in_order) }
    it { expect(CourseLesson).to respond_to(:all_active) }
    it { expect(CourseLesson).to respond_to(:all_destroyed) }
    it { expect(CourseLesson).to respond_to(:all_inactive) }
    it { expect(CourseLesson).to respond_to(:with_url) }
  end
