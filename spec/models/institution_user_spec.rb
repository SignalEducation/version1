...
describe InstitutionUser do
  ...
  it { should ensure_length_of(:student_registration_number).is_at_most(255) }
  it { should ensure_length_of(:membership_number).is_at_most(255) }
  it { should ensure_length_of(:exam_number).is_at_most(255) }
