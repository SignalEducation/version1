...
describe Institution do
  ...
  it { should ensure_length_of(:short_name).is_at_most(255) }
  ...
  it { should ensure_length_of(:feedback_url).is_at_most(255) }
  ...
  it { should ensure_length_of(:help_desk_url).is_at_most(255) }
  ...
  it { should ensure_length_of(:background_colour_code).is_at_most(255) }
