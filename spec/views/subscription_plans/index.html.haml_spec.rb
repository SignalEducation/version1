...
RSpec.describe 'subscription_plans/index', type: :view do
  ...
  it 'renders a list of subscription_plans' do
    ...
    expect(rendered).to match(/#{@subscription_plans.first.price.to_s}/)
    expect(rendered).to match(/#{@subscription_plans.first.available_from.to_s}/)
    expect(rendered).to match(/#{@subscription_plans.first.available_to.to_s}/)
