...
RSpec.describe 'subscription_plans/new', type: :view do
  ...
  xit 'renders edit subscription_plan form' do
    render
    assert_select 'form[action=?][method=?]', subscription_plans_path, 'post' do
      ...
      assert_select 'select#subscription_plan_payment_frequency_in_months[name=?]', 'subscription_plan[payment_frequency_in_months]'
