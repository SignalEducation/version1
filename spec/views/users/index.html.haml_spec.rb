...
RSpec.describe 'users/index', type: :view do
  ...
  it 'renders a list of users' do
    ...
    expect(rendered).to match(/#{@users.first.crypted_password.to_s}/)
    expect(rendered).to match(/#{@users.first.password_salt.to_s}/)
    expect(rendered).to match(/#{@users.first.persistence_token.to_s}/)
    expect(rendered).to match(/#{@users.first.perishable_token.to_s}/)
    expect(rendered).to match(/#{@users.first.single_access_token.to_s}/)
    ...
    expect(rendered).to match(/#{@users.first.password_reset_token.to_s}/)
    expect(rendered).to match(/#{@users.first.password_reset_at.strftime(t('controllers.application.date_formats.standard'))}/)
    expect(rendered).to match(/#{@users.first.stripe_customer.name.to_s}/)
