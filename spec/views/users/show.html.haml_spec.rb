...
RSpec.describe 'users/show', type: :view do
  ...
  it 'renders attributes' do
    ...
    expect(rendered).to match(/#{@user.crypted_password}/)
    expect(rendered).to match(/#{@user.password_salt}/)
    expect(rendered).to match(/#{@user.persistence_token}/)
    expect(rendered).to match(/#{@user.perishable_token}/)
    expect(rendered).to match(/#{@user.single_access_token}/)
    ...
    expect(rendered).to match(/#{@user.stripe_customer.name}/)
