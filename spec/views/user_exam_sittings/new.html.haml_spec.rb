...
RSpec.describe 'user_exam_sittings/new', type: :view do
  before(:each) do
    ...
    @user_exam_sitting = FactoryGirl.build(:user_exam_sitting)
  end

  it 'renders edit user_exam_sitting form' do
    render
    assert_select 'form[action=?][method=?]', user_exam_sittings_path, 'post' do
