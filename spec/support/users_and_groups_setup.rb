...
shared_context 'users_and_groups_setup' do
  ...
  let(:user_list) {[individual_student_user, admin_user, tutor_user, content_manager_user, blogger_user, comp_user, customer_support_manager_user, marketing_manager_user] }
