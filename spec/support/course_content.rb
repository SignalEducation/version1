...
shared_context 'course_content' do
  ...
  # Available on Trial
  let!(:course_module_element_1) { FactoryBot.create(:cme_quiz, course_module: course_module_1, available_on_trial: true) }
  ...
  # Available on Trial
  let!(:course_module_element_2) { FactoryBot.create(:cme_video, course_module: course_module_1, available_on_trial: true) }
  ...
  let!(:course_module_element_3) { FactoryBot.create(:cme_video, course_module: course_module_1) }
  ...
  let!(:course_module_element_4) { FactoryBot.create(:cme_constructed_response, course_module: course_module_1, available_on_trial: true) }
