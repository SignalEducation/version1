    ...
    context 'Correct request' do
      it 'save parsed data in hubspot' do
        ...
        stub_request(:post, "#{uri}/contacts/v1/contact/batch/?hapikey=#{key}").
          with(
            body: "[{\"email\":\"#{user_01.email}\",\"properties\":[{\"property\":\"email\",\"value\":\"#{user_01.email}\"},{\"property\":\"firstname\",\"value\":\"#{user_01.first_name}\"},{\"property\":\"lastname\",\"value\":\"#{user_01.last_name}\"},{\"property\":\"email_verified\",\"value\":false},{\"property\":\"date_of_birth\",\"value\":\"#{user_01.date_of_birth}\"},{\"property\":\"currency\",\"value\":\"#{user_01.currency.name}\"},{\"property\":\"country\",\"value\":\"#{user_01&.country&.name}\"},{\"property\":\"user_group\",\"value\":\"#{user_01&.user_group&.name}\"},{\"property\":\"sub_close_date\",\"value\":null},{\"property\":\"sub_payment_interval\",\"value\":null},{\"property\":\"sub_exam_body\",\"value\":null},{\"property\":\"sub_type\",\"value\":null},{\"property\":\"sub_cancelation_date\",\"value\":null},{\"property\":\"sub_cancelation_reason\",\"value\":null},{\"property\":\"sub_cancelation_note\",\"value\":null},{\"property\":\"next_renewal_date\",\"value\":null},{\"property\":\"preferred_exam_body\",\"value\":\"#{user_01&.preferred_exam_body&.name}\"},{\"property\":\"#{preferred_exam_body1}\",\"value\":\"Basic\"},{\"property\":\"#{preferred_exam_body2}\",\"value\":\"Basic\"}]},{\"email\":\"#{user_02&.email}\",\"properties\":[{\"property\":\"email\",\"value\":\"#{user_02&.email}\"},{\"property\":\"firstname\",\"value\":\"#{user_02&.first_name}\"},{\"property\":\"lastname\",\"value\":\"#{user_02&.last_name}\"},{\"property\":\"email_verified\",\"value\":false},{\"property\":\"date_of_birth\",\"value\":\"#{user_02&.date_of_birth}\"},{\"property\":\"currency\",\"value\":\"#{user_02&.currency&.name}\"},{\"property\":\"country\",\"value\":\"#{user_02&.country&.name}\"},{\"property\":\"user_group\",\"value\":\"#{user_02&.user_group&.name}\"},{\"property\":\"sub_close_date\",\"value\":null},{\"property\":\"sub_payment_interval\",\"value\":null},{\"property\":\"sub_exam_body\",\"value\":null},{\"property\":\"sub_type\",\"value\":null},{\"property\":\"sub_cancelation_date\",\"value\":null},{\"property\":\"sub_cancelation_reason\",\"value\":null},{\"property\":\"sub_cancelation_note\",\"value\":null},{\"property\":\"next_renewal_date\",\"value\":null},{\"property\":\"preferred_exam_body\",\"value\":\"#{user_02&.preferred_exam_body&.name}\"},{\"property\":\"#{preferred_exam_body1}\",\"value\":\"Basic\"},{\"property\":\"#{preferred_exam_body2}\",\"value\":\"Basic\"}]}]",
      ...
      it 'save parsed data with custom data in hubspot' do
        ...
        stub_request(:post, "#{uri}/contacts/v1/contact/batch/?hapikey=#{key}").
          with(
            body: "[{\"email\":\"#{user_01.email}\",\"properties\":[{\"property\":\"email\",\"value\":\"#{user_01.email}\"},{\"property\":\"firstname\",\"value\":\"#{user_01.first_name}\"},{\"property\":\"lastname\",\"value\":\"#{user_01.last_name}\"},{\"property\":\"email_verified\",\"value\":false},{\"property\":\"date_of_birth\",\"value\":\"#{user_01.date_of_birth}\"},{\"property\":\"currency\",\"value\":\"#{user_01.currency.name}\"},{\"property\":\"country\",\"value\":\"#{user_01&.country&.name}\"},{\"property\":\"user_group\",\"value\":\"#{user_01&.user_group&.name}\"},{\"property\":\"sub_close_date\",\"value\":null},{\"property\":\"sub_payment_interval\",\"value\":null},{\"property\":\"sub_exam_body\",\"value\":null},{\"property\":\"sub_type\",\"value\":null},{\"property\":\"sub_cancelation_date\",\"value\":null},{\"property\":\"sub_cancelation_reason\",\"value\":null},{\"property\":\"sub_cancelation_note\",\"value\":null},{\"property\":\"next_renewal_date\",\"value\":null},{\"property\":\"preferred_exam_body\",\"value\":\"#{user_01&.preferred_exam_body&.name}\"},{\"property\":\"#{preferred_exam_body1}\",\"value\":\"Basic\"},{\"property\":\"#{preferred_exam_body2}\",\"value\":\"Basic\"},{\"custom_data\":\"any_data_here\"}]},{\"email\":\"#{user_02&.email}\",\"properties\":[{\"property\":\"email\",\"value\":\"#{user_02&.email}\"},{\"property\":\"firstname\",\"value\":\"#{user_02&.first_name}\"},{\"property\":\"lastname\",\"value\":\"#{user_02&.last_name}\"},{\"property\":\"email_verified\",\"value\":false},{\"property\":\"date_of_birth\",\"value\":\"#{user_02&.date_of_birth}\"},{\"property\":\"currency\",\"value\":\"#{user_02&.currency&.name}\"},{\"property\":\"country\",\"value\":\"#{user_02&.country&.name}\"},{\"property\":\"user_group\",\"value\":\"#{user_02&.user_group&.name}\"},{\"property\":\"sub_close_date\",\"value\":null},{\"property\":\"sub_payment_interval\",\"value\":null},{\"property\":\"sub_exam_body\",\"value\":null},{\"property\":\"sub_type\",\"value\":null},{\"property\":\"sub_cancelation_date\",\"value\":null},{\"property\":\"sub_cancelation_reason\",\"value\":null},{\"property\":\"sub_cancelation_note\",\"value\":null},{\"property\":\"next_renewal_date\",\"value\":null},{\"property\":\"preferred_exam_body\",\"value\":\"#{user_02&.preferred_exam_body&.name}\"},{\"property\":\"#{preferred_exam_body1}\",\"value\":\"Basic\"},{\"property\":\"#{preferred_exam_body2}\",\"value\":\"Basic\"},{\"custom_data\":\"any_data_here\"}]}]",
            headers: { 'Accept' => '*/*', 'Accept-Encoding' => 'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'Content-Type' => 'application/json', 'User-Agent' => 'Ruby' }
          ).
          to_return(status: 202, body: '', headers: {})
