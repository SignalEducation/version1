    ...
    context 'Correct request' do
      it 'save parsed data in hubspot' do
        ...
        stub_request(:post, "#{uri}/contacts/v1/contact?hapikey=#{key}").
          with(body: "{\"properties\":[{\"property\":\"email\",\"value\":\"#{user_01.email}\"},{\"property\":\"firstname\",\"value\":\"#{user_01.first_name}\"},{\"property\":\"lastname\",\"value\":\"#{user_01.last_name}\"},{\"property\":\"email_verified\",\"value\":false},{\"property\":\"date_of_birth\",\"value\":\"#{user_01.date_of_birth}\"},{\"property\":\"currency\",\"value\":\"#{user_01.currency.name}\"},{\"property\":\"country\",\"value\":\"#{user_01&.country&.name}\"},{\"property\":\"sub_close_date\",\"value\":null},{\"property\":\"sub_payment_interval\",\"value\":null},{\"property\":\"sub_exam_body\",\"value\":null},{\"property\":\"sub_type\",\"value\":null},{\"property\":\"sub_cancelation_date\",\"value\":null},{\"property\":\"sub_cancelation_reason\",\"value\":null},{\"property\":\"sub_cancelation_note\",\"value\":null},{\"property\":\"preferred_exam_body\",\"value\":\"#{user_01&.preferred_exam_body&.name}\"},{\"property\":\"#{prederred_exam_body}\",\"value\":\"Basic\"}]}").
    ...
    context 'Correct request' do
      it 'save parsed data in hubspot' do
        ...
        stub_request(:post, "#{uri}/contacts/v1/contact/batch/?hapikey=#{key}").
          with(
            body: "[{\"email\":\"#{user_01.email}\",\"properties\":[{\"property\":\"email\",\"value\":\"#{user_01.email}\"},{\"property\":\"firstname\",\"value\":\"#{user_01.first_name}\"},{\"property\":\"lastname\",\"value\":\"#{user_01.last_name}\"},{\"property\":\"email_verified\",\"value\":false},{\"property\":\"date_of_birth\",\"value\":\"#{user_01.date_of_birth}\"},{\"property\":\"currency\",\"value\":\"#{user_01.currency.name}\"},{\"property\":\"country\",\"value\":\"#{user_01&.country&.name}\"},{\"property\":\"sub_close_date\",\"value\":null},{\"property\":\"sub_payment_interval\",\"value\":null},{\"property\":\"sub_exam_body\",\"value\":null},{\"property\":\"sub_type\",\"value\":null},{\"property\":\"sub_cancelation_date\",\"value\":null},{\"property\":\"sub_cancelation_reason\",\"value\":null},{\"property\":\"sub_cancelation_note\",\"value\":null},{\"property\":\"preferred_exam_body\",\"value\":\"#{user_01&.preferred_exam_body&.name}\"},{\"property\":\"#{prederred_exam_body1}\",\"value\":\"Basic\"},{\"property\":\"#{prederred_exam_body2}\",\"value\":\"Basic\"}]},{\"email\":\"#{user_02&.email}\",\"properties\":[{\"property\":\"email\",\"value\":\"#{user_02&.email}\"},{\"property\":\"firstname\",\"value\":\"#{user_02&.first_name}\"},{\"property\":\"lastname\",\"value\":\"#{user_02&.last_name}\"},{\"property\":\"email_verified\",\"value\":false},{\"property\":\"date_of_birth\",\"value\":\"#{user_02&.date_of_birth}\"},{\"property\":\"currency\",\"value\":\"#{user_02&.currency&.name}\"},{\"property\":\"country\",\"value\":\"#{user_02&.country&.name}\"},{\"property\":\"sub_close_date\",\"value\":null},{\"property\":\"sub_payment_interval\",\"value\":null},{\"property\":\"sub_exam_body\",\"value\":null},{\"property\":\"sub_type\",\"value\":null},{\"property\":\"sub_cancelation_date\",\"value\":null},{\"property\":\"sub_cancelation_reason\",\"value\":null},{\"property\":\"sub_cancelation_note\",\"value\":null},{\"property\":\"preferred_exam_body\",\"value\":\"#{user_02&.preferred_exam_body&.name}\"},{\"property\":\"#{prederred_exam_body1}\",\"value\":\"Basic\"},{\"property\":\"#{prederred_exam_body2}\",\"value\":\"Basic\"}]}]",
