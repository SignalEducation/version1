        ...
        .to eq (
          {
            ...
            override_merchant_preferences: {
              ...
              return_url: "https://staging.learnsignal.com/subscriptions/#{subscription.id}/execute?payment_processor=paypal",
              cancel_url: "https://staging.learnsignal.com/subscriptions/new?flash=It+seems+you+cancelled+your+subscription+on+Paypal.+Still+want+to+upgrade%3F"
            },
            plan: {
