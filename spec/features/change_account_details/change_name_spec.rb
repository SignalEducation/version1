...
describe 'User changing their password' do
  ...
  scenario 'when logged in as an individual_student_user', js: true do
    ...
    expect(page).to have_content I18n.t('views.users.show.h1').upcase
    click_link I18n.t('views.general.edit')
    expect(page).to have_content I18n.t('views.users.edit.h1').upcase
    fill_in I18n.t('views.users.form.first_name'), with: 'Student'
    fill_in I18n.t('views.users.form.last_name'), with: 'Individual'
