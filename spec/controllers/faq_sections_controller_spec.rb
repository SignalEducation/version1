  ...
  context 'Logged in as a marketing_manager_user: ' do
    ...
    describe "POST 'create'" do
      it 'should report OK for valid params' do
        post :create, params: { faq_section: valid_params }
        expect_create_success_with_model('faq_section', public_resources_url)
      end

      it 'should report error for invalid params' do
        post :create, params: { faq_section: {valid_params.keys.first => ''} }
    ...
    describe "PUT 'update/1'" do
      it 'should respond OK to valid params for faq_section_1' do
        put :update, params: { id: faq_section_1.id, faq_section: valid_params }
      ...
      it 'should respond OK to valid params for faq_section_2' do
        put :update, params: { id: faq_section_2.id, faq_section: valid_params }
        expect_update_success_with_model('faq_section', public_resources_url)
        expect(assigns(:faq_section).id).to eq(faq_section_2.id)
      end

      it 'should reject invalid params' do
        put :update, params: { id: faq_section_1.id, faq_section: {valid_params.keys.second => ''} }
    ...
    describe "POST 'reorder'" do
      it 'should be OK with valid_array' do
        post :reorder, params: { array_of_ids: [faq_section_2.id, faq_section_1.id] }
    ...
    describe "DELETE 'destroy'" do
      it 'should be ERROR as children exist' do
        delete :destroy, params: { id: faq_section_1.id }
        expect_delete_error_with_model('faq_section', public_resources_url)
      end

      it 'should be OK as no dependencies exist' do
        delete :destroy, params: { id: faq_section_2.id }
