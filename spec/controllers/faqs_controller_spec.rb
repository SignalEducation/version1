...
describe FaqsController, type: :controller do
  ...
  let!(:valid_params) { FactoryBot.attributes_for(:faq, faq_section_id: faq_section_1.id) }
  ...
  context 'Logged in as a marketing_manager_user: ' do
    ...
    describe "GET 'new'" do
      it 'should respond OK' do
        get :new, params: { faq_section_id: faq_section_1.id }
    ...
    describe "GET 'edit/1'" do
      it 'should respond OK with faq_1' do
        get :edit, params: { id: faq_1.id, faq_section_id: faq_section_1.id }
        expect_edit_success_with_model('faq', faq_1.id)
      end

      # optional
      it 'should respond OK with faq_2' do
        get :edit, params: { id: faq_2.id, faq_section_id: faq_section_2.id }
    ...
    describe "POST 'create'" do
      it 'should report OK for valid params' do
        post :create, params: { faq: valid_params, faq_section_id: faq_section_1.id }
        expect_create_success_with_model('faq', public_resources_url)
      end

      it 'should report error for invalid params' do
        post :create, params: { faq: {valid_params.keys.first => ''}, faq_section_id: faq_section_1.id }
    ...
    describe "PUT 'update/1'" do
      it 'should respond OK to valid params for faq_1' do
        put :update, params: { id: faq_1.id, faq: valid_params }
        expect_update_success_with_model('faq', public_resources_url)
      end

      # optional
      it 'should respond OK to valid params for faq_2' do
        put :update, params: { id: faq_2.id, faq: valid_params }
        expect_update_success_with_model('faq', public_resources_url)
        expect(assigns(:faq).id).to eq(faq_2.id)
      end

      it 'should reject invalid params' do
        put :update, params: { id: faq_1.id, faq: {valid_params.keys.first => ''} }
    ...
    describe "POST 'reorder'" do
      it 'should be OK with valid_array' do
        post :reorder, params: { array_of_ids: [faq_2.id, faq_1.id] }
    ...
    describe "DELETE 'destroy'" do
      it 'should be OK as no dependencies exist' do
        delete :destroy, params: { id: faq_3.id }
