...
describe SubjectCourseResourcesController, type: :controller do
  ...
  let!(:subject_course_resource_2) { FactoryBot.create(:subject_course_resource, subject_course_id: subject_course_1.id) }
  let!(:valid_params) { FactoryBot.attributes_for(:subject_course_resource, subject_course_id: subject_course_1.id) }
  ...
  context 'Logged in as a content_management_user: ' do
    ...
    describe "GET 'show/1'" do
      it 'should see subject_course_resource_1' do
        get :show, params: { id: subject_course_resource_1.id }
      ...
      it 'should see subject_course_resource_2' do
        get :show, params: { id: subject_course_resource_2.id }
    ...
    describe "GET 'edit/1'" do
      it 'should respond OK with subject_course_resource_1' do
        get :edit, params: { id: subject_course_resource_1.id }
      ...
      it 'should respond OK with subject_course_resource_2' do
        get :edit, params: { id: subject_course_resource_2.id }
    ...
    describe "POST 'create'" do
      it 'should report OK for valid params' do
        post :create, params: { subject_course_resource: valid_params }
        expect_create_success_with_model('subject_course_resource', course_resources_url(subject_course_1.id))
      end

      it 'should report error for invalid params' do
        post :create, params: { subject_course_resource: {valid_params.keys.first => ''} }
    ...
    describe "PUT 'update/1'" do
      it 'should respond OK to valid params for subject_course_resource_1' do
        put :update, params: { id: subject_course_resource_1.id, subject_course_resource: valid_params }
        expect_update_success_with_model('subject_course_resource', course_resources_url(subject_course_1.id))
      end

      it 'should reject invalid params' do
        put :update, params: { id: subject_course_resource_1.id, subject_course_resource: {valid_params.keys.first => ''} }
    ...
    describe "DELETE 'destroy'" do
      it 'should be ERROR as children exist' do
        delete :destroy, params: { id: subject_course_resource_1.id }
