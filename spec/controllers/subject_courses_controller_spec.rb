...
describe SubjectCoursesController, type: :controller do
  ...
  # todo: Try to create children for subject_course_1
  let!(:subject_course_1) { FactoryGirl.create(:subject_course) }
  let!(:subject_course_2) { FactoryGirl.create(:subject_course) }
  ...
  context 'Logged in as a individual_student_user: ' do
    ...
    describe "GET 'index'" do
      it 'should respond OK' do
        get :index
        expect_index_success_with_model('subject_courses', 2)
      end
    end
