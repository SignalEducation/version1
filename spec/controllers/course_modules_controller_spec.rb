...
describe CourseModulesController, type: :controller do
  ...
  let!(:course_module_1) { FactoryBot.create(:active_course_module, subject_course_id: subject_course_1.id, course_section_id: course_section_1.id) }
  let!(:course_module_2) { FactoryBot.create(:active_course_module, subject_course_id: subject_course_1.id, course_section_id: course_section_1.id) }

  let!(:valid_params) { FactoryBot.attributes_for(:course_module, course_section_id: course_section_1.id, subject_course_id: subject_course_1.id) }
  ...
  context 'Logged in as a content_management_user: ' do
    ...
    describe "GET 'new'" do
      it 'should respond OK' do
        get :new, params: { id: subject_course_1.id, course_section_id: course_section_1.id }
    ...
    describe "GET 'edit/1'" do
      it 'should respond OK with course_module_1' do
        get :edit, params: { id: subject_course_1.id, course_section_id: course_section_1.id, course_module_id: course_module_1.id }
        expect_edit_success_with_model('course_module', course_module_1.id)
      end

      # optional
      it 'should respond OK with course_module_2' do
        get :edit, params: { id: subject_course_1.id, course_section_id: course_section_1.id, course_module_id: course_module_2.id }
    ...
    describe "PUT 'update/1'" do
      it 'should respond OK to valid params for course_module_1' do
        put :update, params: { id: course_module_1.id, course_module: {name: 'ABC'} }
      ...
      it 'should respond OK to valid params for course_module_2' do
        put :update, params: { id: course_module_2.id, course_module: {name: 'ABC'} }
        expect(flash[:success]).to eq(I18n.t('controllers.course_modules.update.flash.success'))
        expect(flash[:error]).to eq(nil)
        expect(assigns(:course_module).class).to eq(CourseModule)
      ...
      it 'should reject invalid params' do
        put :update, params: { id: course_module_1.id, course_module: {valid_params.keys.first => ''} }
    ...
    describe "POST 'reorder'" do
      it 'should be OK with valid_array' do
        post :reorder, params: { array_of_ids: [course_module_2.id, course_module_1.id] }
    ...
    describe "DELETE 'destroy'" do
      it 'should be OK even though dependencies exist' do
        delete :destroy, params: { id: course_module_1.id }
      ...
      it 'should be OK as no dependencies exist' do
        delete :destroy, params: { id: course_module_2.id }
