  ...
  context 'Logged in as a marketing_manager_user: ' do
    ...
    describe "GET 'show/1'" do
      it 'should see content_page_1' do
        get :show, params: { content_public_url: content_page_1.public_url }
        expect_show_success_with_model('content_page', content_page_1.id)
      end

      # optional - some other object
      it 'should see content_page_2' do
        get :show, params: { content_public_url: content_page_2.public_url }
    ...
    describe "POST 'create'" do
      it 'should report OK for valid params' do
        post :create, params: { content_page: valid_params }
        expect_create_success_with_model('content_page', content_pages_url)
      end

      it 'should report error for invalid params' do
        post :create, params: { content_page: {valid_params.keys.first => ''} }
    ...
    describe "PUT 'update/1'" do
      it 'should respond OK to valid params for content_page_1' do
        put :update, params: { id: content_page_1.id, content_page: valid_params }
      ...
      it 'should respond OK to valid params for content_page_2' do
        put :update, params: { id: content_page_2.id, content_page: valid_params }
        expect_update_success_with_model('content_page', content_pages_url)
        expect(assigns(:content_page).id).to eq(content_page_2.id)
      end

      it 'should reject invalid params' do
        put :update, params: { id: content_page_1.id, content_page: {valid_params.keys.first => ''} }
    ...
    describe "DELETE 'destroy'" do
      it 'should be ERROR as children exist' do
        delete :destroy, params: { id: content_page_1.id }
        expect_delete_success_with_model('content_page', content_pages_url)
      end

      it 'should be OK as no dependencies exist' do
        delete :destroy, params: { id: content_page_2.id }
        expect_delete_success_with_model('content_page', content_pages_url)
      end
    end
