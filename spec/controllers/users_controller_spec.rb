...
describe UsersController, type: :controller do
  ...
  context 'Not logged in...' do
    ...
    describe "POST 'update_courses'" do
      it 'should redirect to root' do
        patch :update_courses, user_id: student_user.id
        expect_bounce_as_not_signed_in
      end
    end
  ...
  context 'Logged in as a student_user' do
    ...
    describe "GET 'reactivate_account'" do
      ...
      it 'successfully render reactivate_account view' do
  ...
  context 'Logged in as a admin_user' do
    ...
    describe "GET 'edxit/1'" do
      ...
      it 'should only allow edxiting of own user' do
