...
describe UsersController, type: :controller do
  ...
  let!(:valid_params)              { attributes_for(:student_user, user_group_id: student_user_group.id, preferred_exam_body_id: exam_body_1.id, video_player: :vimeo) }
  let!(:update_params)             { attributes_for(:student_user, user_group_id: student_user_group.id, preferred_exam_body_id: exam_body_1.id, video_player: :dacast) }
