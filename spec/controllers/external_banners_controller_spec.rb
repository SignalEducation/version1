  ...
  context 'Logged in as a marketing_manager_user: ' do
    ...
    describe "POST 'create'" do
      it 'should report OK for valid params' do
        post :create, params: { external_banner: valid_params }
        expect_create_success_with_model('external_banner', external_banners_url)
      end

      it 'should report error for invalid params' do
        post :create, params: { external_banner: {valid_params.keys.first => ''} }
    ...
    describe "PUT 'update/1'" do
      it 'should respond OK to valid params for external_banner_1' do
        put :update, params: { id: external_banner_1.id, external_banner: valid_params }
      ...
      it 'should respond OK to valid params for external_banner_2' do
        put :update, params: { id: external_banner_2.id, external_banner: valid_params }
        expect_update_success_with_model('external_banner', external_banners_url)
        expect(assigns(:external_banner).id).to eq(external_banner_2.id)
      end

      it 'should reject invalid params' do
        put :update, params: { id: external_banner_1.id, external_banner: {valid_params.keys.first => ''} }
    ...
    describe "POST 'reorder'" do
      it 'should be OK with valid_array' do
        post :reorder, params: { array_of_ids: [external_banner_2.id, external_banner_1.id] }
    ...
    describe "DELETE 'destroy'" do
      it 'should be OK as no dependencies exist' do
        delete :destroy, params: { id: external_banner_2.id }
