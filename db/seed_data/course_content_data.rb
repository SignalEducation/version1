...
CourseSection.where(id: 1).first_or_create!(course_id: 1, name: "Tuition", name_url: "tuition", sorting_order: 1, active: true, counts_towards_completion: true)
CourseSection.where(id: 2).first_or_create!(course_id: 1, name: "Question Bank", name_url: "question-bank", sorting_order: 1, active: true, counts_towards_completion: true)

CourseLesson.where(id: 1).first_or_create!(course_id: 1, course_section_id: 1, name: "Introduction", name_url: "introduction", description: "Intro", sorting_order: 1, estimated_time_in_seconds: 360, active: true)
CourseLesson.where(id: 2).first_or_create!(course_id: 1, course_section_id: 1, name: "Professional Skills", name_url: "professional-skills", description: "sdf", sorting_order: 1, estimated_time_in_seconds: 299, active: true)
CourseLesson.where(id: 3).first_or_create!(course_id: 1, course_section_id: 1, name: "Leadership", name_url: "leadership", description: "sdf", sorting_order: 1, estimated_time_in_seconds: 299, active: true)

CourseLesson.where(id: 4).first_or_create!(course_id: 1, course_section_id: 2, name: "Governance", name_url: "governance", description: "This module discusses Environmental Impact Assessment.", sorting_order: 1, estimated_time_in_seconds: 0, active: true)
CourseLesson.where(id: 5).first_or_create!(course_id: 1, course_section_id: 2, name: "Strategy", name_url: "strategy", description: "This module discusses Environmental Impact Assessment.", sorting_order: 1, estimated_time_in_seconds: 0, active: true)
CourseLesson.where(id: 6).first_or_create!(course_id: 1, course_section_id: 2, name: "Risk", name_url: "risk", description: "This module discusses Environmental Impact Assessment.", sorting_order: 1, estimated_time_in_seconds: 0, active: true)


CourseStep.where(id: 1).first_or_create!(name: "Mergers 101 Video", name_url: "mergers-101", description: "Sed ut perspiciatis unde omnis iste natus error si...", estimated_time_in_seconds: 100, course_lesson_id: 1, sorting_order: 1, is_video: true, is_quiz: false, active: true, number_of_questions: 3, available_on_trial: true)
CourseStep.where(id: 2).first_or_create!(name: "Mergers 102 Quiz", name_url: "mergers-102", description: "Lorem ipsum dolor sit amet, consectetur adipiscing...", estimated_time_in_seconds: 100, course_lesson_id: 1, sorting_order: 2, is_video: false, is_quiz: true, active: true, number_of_questions: 3, available_on_trial: true, related_course_step_id: 1)
CourseStep.where(id: 3).first_or_create!(name: "Mergers 103 Video", name_url: "mergers-103", description: "What is a Merger", estimated_time_in_seconds: 180, course_lesson_id: 1, sorting_order: 2, is_video: true, is_quiz: false, active: true, number_of_questions: 3, available_on_trial: false)
CourseStep.where(id: 4).first_or_create!(name: "Mergers 104 Quiz", name_url: "mergers-104", description: "This is the description", estimated_time_in_seconds: 180, course_lesson_id: 1, sorting_order: 1, is_video: false, is_quiz: true, active: true, number_of_questions: 3, available_on_trial: false)

CourseStep.where(id: 5).first_or_create!(name: "Quant Methods 101 Video", name_url: "quant-methods-101-video", description: "This is an introduction", estimated_time_in_seconds: 180, course_lesson_id: 2, sorting_order: 5, is_video: true, is_quiz: false, active: true, number_of_questions: 3, available_on_trial: true)
CourseStep.where(id: 6).first_or_create!(name: "Quant Methods 102 Quiz", name_url: "quant-methods-102-quiz", description: "This is an introduction", estimated_time_in_seconds: 180, course_lesson_id: 2, sorting_order: 5, is_video: false, is_quiz: true, active: true, number_of_questions: 3, available_on_trial: true)
CourseStep.where(id: 7).first_or_create!(name: "Quant Methods 103 Video", name_url: "quant-methods-103-video", description: "This is an introduction", estimated_time_in_seconds: 180, course_lesson_id: 2, sorting_order: 5, is_video: true, is_quiz: false, active: true, number_of_questions: 3, available_on_trial: true)
...
CourseVideo.where(id: 3).first_or_create!(course_step_id: 5, vimeo_guid: '326872692', dacast_id: '326872692', duration: 200)
...
CourseQuiz.where(id: 3).first_or_create!(course_step_id: 6, number_of_questions: 10, question_selection_strategy: "random")
CourseQuiz.where(id: 4).first_or_create!(course_step_id: 9, number_of_questions: 10, question_selection_strategy: "random")

VideoResource.where(id: 1).first_or_create!(course_step_id: 1, name: "Climate system notes", web_url: "http://en.wikipedia.org/wiki/Climate")

# Belong to CME 2
QuizQuestion.where(id: 1).first_or_create!(course_quiz_id: 1, course_step_id: 2)
QuizQuestion.where(id: 2).first_or_create!(course_quiz_id: 1, course_step_id: 2)
QuizQuestion.where(id: 3).first_or_create!(course_quiz_id: 1, course_step_id: 2)
QuizQuestion.where(id: 4).first_or_create!(course_quiz_id: 1, course_step_id: 2)
QuizQuestion.where(id: 5).first_or_create!(course_quiz_id: 1, course_step_id: 2)
QuizQuestion.where(id: 6).first_or_create!(course_quiz_id: 1, course_step_id: 2)
QuizQuestion.where(id: 7).first_or_create!(course_quiz_id: 1, course_step_id: 2)
QuizQuestion.where(id: 8).first_or_create!(course_quiz_id: 1, course_step_id: 2)
QuizQuestion.where(id: 9).first_or_create!(course_quiz_id: 1, course_step_id: 2)
QuizQuestion.where(id: 10).first_or_create!(course_quiz_id: 1, course_step_id: 2)
# Belong to CME 4
QuizQuestion.where(id: 11).first_or_create!(course_quiz_id: 2, course_step_id: 4)
QuizQuestion.where(id: 12).first_or_create!(course_quiz_id: 2, course_step_id: 4)
QuizQuestion.where(id: 13).first_or_create!(course_quiz_id: 2, course_step_id: 4)
QuizQuestion.where(id: 14).first_or_create!(course_quiz_id: 2, course_step_id: 4)
QuizQuestion.where(id: 15).first_or_create!(course_quiz_id: 2, course_step_id: 4)
QuizQuestion.where(id: 16).first_or_create!(course_quiz_id: 2, course_step_id: 4)
QuizQuestion.where(id: 17).first_or_create!(course_quiz_id: 2, course_step_id: 4)
QuizQuestion.where(id: 18).first_or_create!(course_quiz_id: 2, course_step_id: 4)
QuizQuestion.where(id: 19).first_or_create!(course_quiz_id: 2, course_step_id: 4)
QuizQuestion.where(id: 20).first_or_create!(course_quiz_id: 2, course_step_id: 4)
# Belong to CME 6
QuizQuestion.where(id: 21).first_or_create!(course_quiz_id: 3, course_step_id: 6)
QuizQuestion.where(id: 22).first_or_create!(course_quiz_id: 3, course_step_id: 6)
QuizQuestion.where(id: 23).first_or_create!(course_quiz_id: 3, course_step_id: 6)
QuizQuestion.where(id: 24).first_or_create!(course_quiz_id: 3, course_step_id: 6)
QuizQuestion.where(id: 25).first_or_create!(course_quiz_id: 3, course_step_id: 6)
QuizQuestion.where(id: 26).first_or_create!(course_quiz_id: 3, course_step_id: 6)
QuizQuestion.where(id: 27).first_or_create!(course_quiz_id: 3, course_step_id: 6)
QuizQuestion.where(id: 28).first_or_create!(course_quiz_id: 3, course_step_id: 6)
QuizQuestion.where(id: 29).first_or_create!(course_quiz_id: 3, course_step_id: 6)
QuizQuestion.where(id: 30).first_or_create!(course_quiz_id: 3, course_step_id: 6)
# Belong to CME 4
QuizQuestion.where(id: 31).first_or_create!(course_quiz_id: 4, course_step_id: 9)
QuizQuestion.where(id: 32).first_or_create!(course_quiz_id: 4, course_step_id: 9)
QuizQuestion.where(id: 33).first_or_create!(course_quiz_id: 4, course_step_id: 9)
QuizQuestion.where(id: 34).first_or_create!(course_quiz_id: 4, course_step_id: 9)
QuizQuestion.where(id: 35).first_or_create!(course_quiz_id: 4, course_step_id: 9)
QuizQuestion.where(id: 36).first_or_create!(course_quiz_id: 4, course_step_id: 9)
QuizQuestion.where(id: 37).first_or_create!(course_quiz_id: 4, course_step_id: 9)
QuizQuestion.where(id: 38).first_or_create!(course_quiz_id: 4, course_step_id: 9)
QuizQuestion.where(id: 39).first_or_create!(course_quiz_id: 4, course_step_id: 9)
QuizQuestion.where(id: 40).first_or_create!(course_quiz_id: 4, course_step_id: 9)
