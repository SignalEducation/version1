...
ActiveRecord::Schema.define(version: 2020_03_23_083712) do
  ...
  create_table "course_tutor_details", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["course_id"], name: "index_course_tutor_details_on_course_id"
  ...
  create_table "module_logs", id: :serial, force: :cascade do |t|
    t.integer "course_module_element_id"
    t.integer "user_id"
    ...
    t.index ["course_id"], name: "index_module_logs_on_course_id"
    t.index ["course_log_id"], name: "index_module_logs_on_course_log_id"
  ...
  create_table "section_logs", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.integer "course_section_id"
    t.integer "course_log_id"
    t.integer "latest_course_module_element_id"
    ...
    t.integer "course_id"
    t.integer "count_of_constructed_responses_taken"
    t.index ["course_id"], name: "index_section_logs_on_course_id"
    t.index ["course_log_id"], name: "index_section_logs_on_course_log_id"
    t.index ["course_section_id"], name: "index_section_logs_on_course_section_id"
    t.index ["user_id"], name: "index_section_logs_on_user_id"
  end
  ...
  create_table "student_exam_tracks", id: :serial, force: :cascade do |t|
    ...
    t.integer "course_section_id"
    t.integer "course_section_user_log_id"
    t.index ["course_id"], name: "index_student_exam_tracks_on_course_id"
    t.index ["course_log_id"], name: "index_student_exam_tracks_on_course_log_id"
