class ExamLevelsController < ApplicationController
  ...
  def allowed_params
    params.require(:exam_level).permit(:qualification_id, :name, :name_url, :is_cpd, :sorting_order, :active, :default_number_of_possible_exam_answers, :enable_exam_sections, :description, :seo_description, :seo_no_index, :tutor_id, :live)
  end
