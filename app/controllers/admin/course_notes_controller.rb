...
module Admin
  class CourseNotesController < ApplicationController
    ...
    def allowed_params
      params.require(:course_note).permit(
        :course_step_id, :name, :description, :web_url, :upload, :download_available,
        :upload_file_name, :upload_content_type, :upload_file_size, :upload_updated_at, :_destroy
      )
    end
  end
end
