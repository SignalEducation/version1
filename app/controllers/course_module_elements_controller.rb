  ...
  def create
    ...
    if @course_module_element.save
      ...
      if params[:commit] == I18n.t('views.course_module_elements.form.save_and_add_another')
        ...
        redirect_to show_course_module_url(@course_module_element.course_module.subject_course_id, @course_module_element.course_section.id, @course_module_element.course_module.id)
      end
    else
      if params[:commit] == I18n.t('views.course_module_element_quizzes.form.advanced_setup_link')
        spawn_quiz_children
