class CoursesController < ApplicationController
  ...
  def show
    ...
    if @course_module
      ...
      seo_title_maker("#{institution.short_name} - #{exam_level.name} - #{@course_module_element.try(:name)}", @course_module_element.seo_description, @course_module_element.seo_no_index)
    end
