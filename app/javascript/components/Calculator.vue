<template>
  <div class="calc-main" id="calc-main">
...
<script src='../lib/Calculator/index.min.js'></script>
...
.calc-main {
  ...
  border-radius: 12px;
  box-shadow: inset 0px -38px 5px #3d3d5b,
    inset 0px 6px 4px rgba(255, 255, 255, 0.25),
    inset 0px 2px 1px rgba(255, 255, 255, 0.25),
    inset 3px 0px 3px rgba(255, 255, 255, 0.25), inset -4px 0px 4px #3d3d5b;
  background: #3d3d5b; /* Old browsers */
  background: -moz-linear-gradient(top, #3d3d5b 45%, #3d3d5b 80%); /* FF3.6+ */
  background: -webkit-gradient(
    linear,
    left top,
    left bottom,
    color-stop(45%, #3d3d5b),
    color-stop(80%, #3d3d5b)
  ); /* Chrome,Safari4+ */
  ...
  background: -ms-linear-gradient(top, #3d3d5b 45%, #3d3d5b 80%); /* IE10+ */
  background: linear-gradient(to bottom, #3d3d5b 45%, #3d3d5b 80%); /* W3C */
