...
class User < ActiveRecord::Base
  ...
  def destroyable?
    !self.admin? && self.course_modules.empty? && self.invoices.empty? && self.institution_users.empty? && self.subscriptions.empty? && self.subscription_payment_cards.empty? && self.subscription_transactions.empty?
  end
